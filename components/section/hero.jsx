  ...
  return(
    <section className="bg-blackless">
      ...
      <div className="bg-black lg:w-[53%] lg:pt-10 pt-6 lg:px-10 px-6 pb-2 lg:absolute top-28 left-10 text-xl">
          ...
          <a href="#" className="gap-2 flex hover:text-black hover:bg-white w-fit">
        ...
        <div className="flex justify-between mt-4">
          <div className="border rounded-full p-1 h-fit w-fit"><BsChevronLeft/></div>
          <div className="flex">
            <div className="text-4xl"><GoPrimitiveDot/></div>
            <div className="my-auto"><GoPrimitiveDot/></div>
            <div className="my-auto"><GoPrimitiveDot/></div>
            <div className="my-auto"><GoPrimitiveDot/></div>
          </div>
          <div className="border rounded-full p-1 h-fit w-fit"><BsChevronRight/></div>
        </div>
        </div>
